...
<html lang="en">
    ...
    <link href="<?php echo __PATH_TEMPLATE_CSS__; ?>vip.css" rel="stylesheet">
    <link href="<?php echo __PATH_TEMPLATE_CSS__; ?>roulette.css" rel="stylesheet">
		<script>
	...
	<body>
		<div class="wrapper">
			<header class="header">
				...
				<div class="logo">
					<a href="<?php echo __BASE_URL__; ?>"><img src="<?php echo __PATH_TEMPLATE_IMG__; ?>endless-logo.png" width="607px" height="auto" lt=""></a>
				</div>
	...
	<script src='<?php echo __PATH_TEMPLATE_JS__; ?>ThrowPropsPlugin.min.js'></script>
	<script src='<?php echo __PATH_TEMPLATE_JS__; ?>Spin2WinWheel.js'></script>
	<script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/latest/plugins/TextPlugin.min.js'></script>
	<script src="<?php echo __PATH_TEMPLATE_JS__; ?>roulette.js"></script>
	</body>
</html>