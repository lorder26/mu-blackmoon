   ...
   <source src="http://s6.imperium-mu.com/video/mu.mp4" type="video/mp4">
			...
			<header class="header">
				...
				<main class="content">
					...
					<div class="block-widget">
						<?php include(__PATH_TEMPLATE_ROOT__ . 'inc/modules/top.players.php'); ?>	
						<?php include(__PATH_TEMPLATE_ROOT__ . 'inc/modules/top.guilds.php'); ?>	
						<?php include(__PATH_TEMPLATE_ROOT__ . 'inc/modules/rss.php'); ?>	
					</div>
		...
		<div id="login-login" class="modal_div"> 
			...
			<div class="modal-content">
				<div class="logo-re"><a href="/"><img src="<?php echo __PATH_TEMPLATE_IMG__; ?>g" alt=""></a></div>
